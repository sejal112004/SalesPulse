...
class IgnoreChromeDevTools404Filter:
    def filter(self, record):
        import re
        return not re.search(r'\.well-known/appspecific', record.getMessage())
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            BASE_DIR / 'analyzer/admin_panel/templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Media/Upload files
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'analyzer/uploads'
...
LOGGING = {
    ...
    'filters': {
        'ignore_chrome_devtools': {
            '()': 'core.settings.IgnoreChromeDevTools404Filter',  # make sure the path matches your project
        },
    },
    'handlers': {
        'console': {
